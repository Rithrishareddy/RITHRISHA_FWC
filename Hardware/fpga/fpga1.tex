...
\begin{itemize}
    \item Repository with code and schematics: \\
...
\begin{itemize}
    \item Understood the functioning of 7-segment display and interfacing with Arduino.
    \item Gained hands-on experience in implementing logical expressions using hardware.
    \item Learned how to apply theoretical concepts to solve real-world exam problems.
    \item Practiced pin configuration, code uploading, and input/output validation.
\end{itemize}
